...
# Copy BOTH architecture .txz archives generated by debian/rules
cp ../../${PACKAGE_NAME}*${PACKAGE_VERSION}*.txz rpmbuild/SOURCES/
...
# LOOP 1: Build the native AMD64 RPM package
